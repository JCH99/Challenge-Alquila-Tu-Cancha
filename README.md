...
Para correr la aplicación en **PRODUCTION MODE** correr **npm run build**. La carpeta \build será generada y la aplicación optimizada podrá ser deployada localmente utilizando **npm install -g serve** y **serve -s build**.\
