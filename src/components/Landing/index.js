    ...
    <>
      <Box>
        ...
        <Typography variant="body1" align="center" sx={{ mb: 2 }}>
          ...
          reprehenderit! Officiis ut beatae, officia excepturi vero ipsa
          corrupti reiciendis numquam sed, dolorem omnis enim dolorum natus,
          modi impedit placeat laboriosam perspiciatis architecto aut illo eaque
          blanditiis sint itaque necessitatibus. Minus officia atque alias
          voluptatem deleniti placeat quis molestias, quasi dignissimos nihil
          sunt dolore ab, eius quaerat, minima illo molestiae? Blanditiis,
          recusandae eligendi?
        </Typography>
